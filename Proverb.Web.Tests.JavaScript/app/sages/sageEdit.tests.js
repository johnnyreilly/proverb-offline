describe("Proverb.Web -> app-> controllers ->", function () {
    ...
    describe("sageEdit ->", function () {
        var $rootScope, $q, getById_deferred, $location, $scope, $routeParams_stub, common, datacontext, $controller, sageEditController; // the controller
...
//# sourceMappingURL=sageEdit.tests.js.map